...
3) Faça um programa (ou uma função) que some os elementos 
acima da diagonal principal de uma matriz quadrada.

*******************************************************************************/
#include <stdio.h>


void somaAcimaDiagonalPrincipal(int dimensao, int M[dimensao][dimensao]){
...
int main()
{
    ...
    somaAcimaDiagonalPrincipal(dimensao, M);
